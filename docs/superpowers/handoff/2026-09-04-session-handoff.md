...
- 스펙(source of truth): `docs/superpowers/specs/2026-09-04-lunch-roulette/` 01~17. 17은 식당 수집 확장. 13은 백로그, 14는 유저플로우 해피케이스(Mermaid 원본), 15는 시각 디자인, 16은 퍼스널 맵(기록 탭 지도).
